      ...
      <div className="pt-[120px] lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
          ...
          <div className="flex flex-col items-center">
            <form
              ...
              className="w-[90%] bg-[#282828] text-white mb-[2rem] rounded-[10px] flex flex-col px-[1rem] pb-[2.5rem]"
            >
               <div
                onClick={() => {
              ...
              >
                <p className="text-[#282828]">{category}</p>
                <p className="text-[#282828]">&#8964;</p>
              </div>
              ...
              {categories ? (
                <div className="flex flex-col items-center mt-[1rem] bg-blue-300 py-[1rem] rounded-[10px]">
                  <p
                    onClick={() => {
                      setcategories(false);
                      setcategory("Luxurah Collections");
                    }}
