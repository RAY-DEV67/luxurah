export function Footer() {
    return ( <div className="bg-[#282828] text-white rounded-t-[20px] mt-[2rem] footer py-[1rem]">
        <div className="mx-[1rem]">
        <p className="text-2xl mb-[1rem] text-white font-bold">Contact Us</p>
        <div className="flex">
