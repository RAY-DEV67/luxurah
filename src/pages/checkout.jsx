         ...
         <p className="text-center pt-[1rem] text-2xl">Check-Out</p>
          ...
          <div className="my-[2rem] mx-[1rem]">
            ...
            <div className="border-[#282828] border my-[1rem] p-[1rem] text-left">
              ...
              <button onClick={upload}  className="text-[#ffffff] rounded-[20px] bg-[#282828] font-bold w-[30%] mt-[2rem] py-[0.5rem] px-[1rem]">Upload</button>
            </div>
          </div>
...
<label className="text-left mt-[0.5rem] opacity-0">Product</label>
                    ...
                    />
    <div>
    <input type="submit" value="Place Order" className="text-[#ffffff] rounded-[20px] bg-[#282828] font-bold w-[50%] mt-[2rem] py-[0.5rem] px-[1rem]" />
